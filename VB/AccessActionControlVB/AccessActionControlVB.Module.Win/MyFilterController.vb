...
Partial Public Class MyFilterController
		...
		Protected Overrides Sub OnDeactivating()
			RemoveHandler DefaultBarActionItemsFactory.CustomizeActionControl, AddressOf DefaultBarActionItemsFactory_CustomizeActionControl
			MyBase.OnDeactivating()
		End Sub
		Private Sub DefaultBarActionItemsFactory_CustomizeActionControl(ByVal sender As Object, ByVal e As CustomizeActionControlEventArgs(Of ActionBase))
